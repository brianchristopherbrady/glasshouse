...
// self-reporting a real decision it made, not something AGENTARIUM inferred.
// Per charter.md, this should be used sparingly, at meaningful transitions —
// not before every tool call. Named without a dot: MCP tool names must match
// [a-z0-9_-]+, so "agentarium.trace_decision" (as prose-referenced elsewhere)
// is invalid as an actual registered tool name.
import { z } from "zod";
