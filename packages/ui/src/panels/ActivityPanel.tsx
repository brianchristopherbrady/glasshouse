...
function tally(events: FlowbookEvent[], predicate: (e: FlowbookEvent) => string | undefined): Tally[] {
...
function metaString(event: FlowbookEvent, key: string): string | undefined {
  const value = event.metadata?.[key];
  return typeof value === "string" ? value : undefined;
}

export function ActivityPanel({ events }: { events: FlowbookEvent[] }) {
