  ...
  return (
    <div className="rounded-lg border border-border bg-surface-raised p-4 text-sm">
      ...
      <dl className="mt-3 grid grid-cols-2 gap-y-1 text-xs">
        ...
        <dd className="mono text-text">{new Date(span.startTime).toLocaleTimeString()}</dd>
      ...
      {hasAttrs && (
        <div className="mt-3">
          <div className="text-xs uppercase tracking-wide text-text-muted">Attributes</div>
          <pre className="mono mt-1 max-h-48 overflow-auto rounded bg-surface-sunken p-2 text-[11px] text-text">
